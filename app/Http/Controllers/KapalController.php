    ...
    public function store(Request $request)
{
    Validator::make($request->all(), [
        ...
        'pemilik_id' => 'required|exists:pemiliks,id', // WAJIB
    ], [
    ...
    public function update(Request $request, Kapal $kapal)
    {
        Validator::make($request->all(), 
        [
        'pemilik_id' => 'required|string|unique:pemiliks, nama',
        ...
        'catatan' => 'catatan',
            ...
            $kapal->update([
                ...
                return redirect('/dashboard')->with(['success' => 'Data sudah terupdate']);
