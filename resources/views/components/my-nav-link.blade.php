...
@php
    // $classes = $curent ? 'bg-gray-900 dark:bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'
    if ($current) {
        $classes = 'bg-gray-900 dark:bg-gray-950/50 text-white';
        $ariaCurrent = 'page';
    } else {
