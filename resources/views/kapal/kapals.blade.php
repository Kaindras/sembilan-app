    ...
    @endif --}}
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search vessel ..." autofocus autocomplete="off" name="search" />
                <button type="submit"
            ...
            @forelse($kapals as $kapal)
                @if (!@empty($kapal->no_sertifikat))
                    <article
                        ...
                        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> <a
                                href="/kapals/{{ $kapal['id'] }}" class="hover:underline">{{ $kapal->nama_kapal }}</h2>
                        <br>
                        <div class="flex items-center gap-2">
                            <img src="/img/label.jpeg" alt="icon" class="w-20 h-10">
                            <span class="text-sm">
                                <p class="text-gray-500 dark:text-gray-400 text-xs">&copy; 2025 | Supported by the
                                    Management of MFQAA Denpasar </p>
                            </span>
                        </div>
